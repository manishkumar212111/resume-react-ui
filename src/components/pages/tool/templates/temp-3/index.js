...
const Index = (props) => {
  ...
  return (
    <main className={`resumeMain3 ${resume_detail.style.fontSize == 12 ? "smallTxt" : (resume_detail.style.fontSize == 14 ? "mediumTxt" : (resume_detail.style.fontSize == 16 ? "largeTxt" : "extraLargeTxt"))}`} style={{backgroundColor : resume_detail?.style?.background, color: resume_detail?.style?.text_color}}>
      <div className="resumeLeft3">
            <div className="resumeProfile">
                  {props.resume_detail.job_title && <div className="resumePosTitle"
                ...
                />}
                <h1>Hello I’m <span>{basic_info.first_name} {basic_info.last_name}</span></h1>          
                {resume_detail.summary && <p className="resumeAboutMe" dangerouslySetInnerHTML={{
                    __html: (resume_detail.summary
                ...
                resume_detail.conferences.map((item, index) =>
                    ...
                    >
                      <span className="title">
                        {item.title ? item.title : "Title"} <span class="dateYear">{item.date ? item.date : "date"}</span>
                      </span>
        ...
        {(resume_detail.sample_map && resume_detail.sample_map.volunteers) && 
            ...
            <div className="resumeConference">
                ...
                {resume_detail.volunteers && resume_detail.volunteers.map((item, index) => (
                    <div className="resumeConfRecBlk">
                        <span className="title">{item.title ? item.title : "Title"} <span class="dateYear">{item.date ? item.date : "date"}</span></span>
