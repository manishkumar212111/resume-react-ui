...
const Index = (props) => {
  ...
  return (
    <main className={`resumeMain4 ${resume_detail.style.fontSize == 12 ? "smallTxt" : (resume_detail.style.fontSize == 14 ? "mediumTxt" : (resume_detail.style.fontSize == 16 ? "largeTxt" : "extraLargeTxt"))}`} style={{backgroundColor : resume_detail?.style?.background, color: resume_detail?.style?.text_color}}>
      <div className="resumeAboutTop">
            {resume_detail.profileImage && <div className="resumeProfilePic">
                <div className="resumePP">
                    <img src={resume_detail.profileImage ? resume_detail.profileImage : Img} alt=""/>
                </div>
            </div>}
            <div className="resumeDesp">                
